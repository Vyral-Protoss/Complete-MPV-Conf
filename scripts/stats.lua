-- stats.lua by Argon- ; https://github.com/Argon-/mpv-stats
-- Customized by Vyral 
--
-- Display some stats.
--
...
-- visible.
--
-- see Property list at https://github.com/mpv-player/mpv/blob/master/DOCS/man/input.rst
...
function add_version(s)
    ...
    append_property(s, sec, "mpv-version", {prefix="MPV:", nl="", indent=""})
end
